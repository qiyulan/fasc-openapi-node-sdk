...
export declare type GetUserSealListResponse = SealInfoForUserList & {
    sealStatus: string;
};
...
export declare type GetSealVerifyListResponse = Array<VerifyInfo>;
...
export declare type CancelSealGrantResponse = null;
...
/** cancelSealFreeSign 解除印章免验证签-请求结构体 */
export declare type CancelSealFreeSignResponse = null;
...
export declare type ModifySealResponse = null;
...
export declare type DeleteSealResponse = null;
...
export declare type CancelPersonalFreeSignResponse = null;
...
export declare type DeletePersonalSealResponse = null;
export {};
