...
export declare type SetDocTemplateStatusResponse = null;
...
export declare type DeleteDocTemplateResponse = null;
...
export declare type SetSignTemplateStatusResponse = null;
...
/** deleteSignTemplate 删除签署任务模板-请求结构体 */
export declare type DeleteSignTemplateResponse = null;
...
export declare type SetAppDocTemplateStatusResponse = null;
...
export declare type DeleteAppDocTemplateResponse = null;
...
export declare type SetAppSignTemplateStatusResponse = null;
...
export declare type CreateAppFieldResponse = null;
...
export declare type ModifyAppFieldResponse = null;
...
/** setAppFieldStatus 设置业务控件状态-请求结构体 */
export declare type SetAppFieldStatusResponse = null;
/** getAppFieldList 查询业务控件列表-请求结构体 */
export declare type GetAppFieldListRequest = null;
...
export declare type DeleteCorpFieldResponse = null;
