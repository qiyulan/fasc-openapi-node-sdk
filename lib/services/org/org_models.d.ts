...
export declare type ModifyCorpDeptResponse = null;
...
/** deleteCorpDept 删除部门-请求结构体 */
export declare type DeleteCorpDeptResponse = null;
...
export declare type CrateCorpMemberResponse = Array<SimpleEmployeeInfo>;
...
export declare type ModifyMemberResponse = null;
...
export declare type DeleteMemberResponse = null;
...
export declare type GetActiveMemberUrlResponse = Array<SimpleEmployeeInfo>;
...
export declare type SetMemberDeptResponse = null;
/** setMemberDept 设置成员所属部门-请求结构体 */
...
/** setMemberStatus 设置成员状态-响应结构体 */
export declare type SetMemberStatusResponse = null;
export {};
