...
class Sign {
    static sign({ signStr, timestamp, appSecret, }) {
        // SHA256算法加密排序后的字符串
        const signText = crypto__namespace.createHash("sha256").update(signStr).digest("hex");
        const timestampSecret = crypto__namespace
...
class AbstractClient {
    constructor({ serverUrl, credential, profile }) {
        ...
        this.profile = {
            signMethod: (profile === null || profile === void 0 ? void 0 : profile.signMethod) || SignMethod.hamcsha256,
