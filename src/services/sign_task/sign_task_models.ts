...
export type UrgeSignTaskResponse = null
...
/** finish 结束签署任务-响应结构体 */
export type FinishResponse = null
...
export interface GetDetailResponse {
  ...
  actors: { 
    actorInfo: Array<ActorInfo & { isInitiator: boolean }>
...
export type GetSignTaskCatalogListResponse = Array<SignTaskCatalog>
...
export type GetSignTaskBusinessTypeListResponse = Array<BusinessType>
