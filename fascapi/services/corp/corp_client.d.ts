...
export declare class Client extends AbstractClient {
     ...
     */
    addCorp(req: AddCorpRequest): Promise<AddCorpResponse>;
    /**
     * 为已添加的企业修改在应用系统中的关联参数
     */
    updateCorp(req: UpdateCorpRequest): Promise<UpdateCorpResponse>;
    /**
     * 删除企业。删除后再次使用相同的clientCorpId添加该企业时，返回新的openCorpId
     */
    deleteCorp(req: DeleteCorpRequest): Promise<DeleteCorpResponse>;
    /**
     * 将已添加的企业用户暂时禁用。禁用后，该企业暂时不能通过该应用系统使用法大大平台服务
     */
    disableCorp(req: DisableCorpRequest): Promise<DisableCorpResponse>;
    /**
     * 将已禁用的企业用户再次激活。激活后，该企业用户可继续通过该应用系统使用法大大平台服务
     */
    enableCorp(req: EnableCorpRequest): Promise<EnableCorpResponse>;
    /**
   * 将已禁用的企业用户再次激活。激活后，该企业用户可继续通过该应用系统使用法大大平台服务
   */
    unbindCorp(req: UnbindCorpRequest): Promise<UnbindCorpResponse>;
    /**
     ...
     */
    getBasicInfo(req: GetBasicInfoRequest): Promise<GetBasicInfoResponse>;
    /**
