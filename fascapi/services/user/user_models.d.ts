...
/** 获取个人用户身份信息-请求参数结构体 */
export interface GetIdentInfoRequest {
    openUserId: string;
}
/** 获取个人用户身份信息-响应参数结构体 */
export interface GetIdentInfoResponse {
    openUserId: string;
    /** 实名认证状态: unidentified: 未认证, identified: 已认证且有效, ident_invalid：认证失效*/
    identStatus: string;
    userInfo?: UserIdentInfo;
...
export interface GetIdentProgressRequest {
    openUserId: string;
}
/** 查询个人用户实名认证进度-响应参数结构体 */
export interface GetIdentProgressResponse {
