...
/** 填写方状态 */
export declare enum FillActorStatusEnum {
    /** 未投递 (尚未发送给本填写方) */
    NO_SEND = "no_send",
    /** 待接收 (正在等待本填写方接收) */
    TO_ACCEPT = "to_accept",
...
/** 签署方状态 */
export declare enum SignActorStatusEnum {
    /** 未投递  (尚未发送给本签署方) */
    NO_SEND = "no_send",
    /** 待接收  (正在等待本签署方接收) */
    TO_ACCEPT = "to_accept",
...
export declare enum SignerSignMethodEnum {
...
/** 签署任务状态 */
export declare enum SignTaskStatusEnum {
    /** 任务已创建 (签署任务创建成功，但未发起) */
...
/** 允许该参与方使用的身份和意愿确认方式 */
export declare enum VerifyMethodEnum {
    /** 短信验证码 */
    SMS = "sms",
    /** 刷脸验证 */
    FACE = "face",
